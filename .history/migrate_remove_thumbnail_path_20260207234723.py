    ...
    with app.app_context():
        try:
            ...
            with db.engine.connect() as conn:
                result = conn.execute(text("PRAGMA table_info(file_metadata);")).fetchall()
            ...
            with db.engine.begin() as conn:
                ...
                # Drop old table
                conn.execute(text("DROP TABLE file_metadata;"))
                
                # Rename new table
                conn.execute(text("ALTER TABLE file_metadata_new RENAME TO file_metadata;"))
            ...
            with db.engine.connect() as conn:
                ...
                total_records = conn.execute(text("SELECT COUNT(*) FROM file_metadata")).fetchone()[0]
