...
exanple
```python
# First run - processes 1000 files, you stop at 500
python process_images.py --folder "/home/user/images" --workers 4

# Second run - automatically skips the 500 done, processes remaining 500
python process_images.py --folder "/home/user/images" --workers 4